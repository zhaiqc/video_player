...
class PlayerLifeCycle extends StatefulWidget {
  ...
  PlayerLifeCycle(this.uri,this.isHorizontal,this.widthPercentage,this.heightPercentage,this.childBuilder);
...
class _PlayerLifeCycleState extends State<PlayerLifeCycle> {
  ...
  void initState() {
    super.initState();
    controller = new VideoPlayerController(widget.uri,widget.isHorizontal,widget.widthPercentage,widget.heightPercentage);
