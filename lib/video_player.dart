...
class VideoPlayerValue {
  ...
  VideoPlayerValue copyWith({
    ...
    return new VideoPlayerValue(
      ...
      isBackLayer: isBackLayer ?? this.isBackLayer,
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  int _textureId;
  final String uri;
  final bool isHorizontal;//判断横屏
  final double widthPercentage;//width百分比
  final double heightPercentage;//height百分比
  Timer timer;
  ...
  Future<Null> initialize() async {
    ...
    final Map<dynamic, dynamic> response = await _channel.invokeMethod(
      'create',
      <String, dynamic>{'dataSource': uri,'isHorizontal':isHorizontal,'widthPercentage':widthPercentage,'heightPercentage':heightPercentage},
    );
  ...
  Future<Null> setBackLayer(bool backLayer) async {
    value = value.copyWith(isBackLayer: backLayer);
    await _applyBackLayer();
  }
  ...
  Future<Null> _applyBackLayer() async {
    if (!value.initialized || isDisposed) {
      return;
    }
    _channel.invokeMethod(
      'setBackLayer',
      <String, dynamic>{'textureId': _textureId, 'backLayer': value.isBackLayer},
    );
  }
...
class VideoProgressColors {
  ...
  VideoProgressColors({
    this.playedColor: const Color.fromRGBO(255, 0, 0, 0.0),
    this.bufferedColor: const Color.fromRGBO(50, 50, 200, 0.0),
    this.backgroundColor: const Color.fromRGBO(200, 200, 200, 0.0),
  });
}
