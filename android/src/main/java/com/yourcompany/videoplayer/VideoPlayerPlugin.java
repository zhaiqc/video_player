...
//            mediaPlayer.reload(url,false);
////            mediaPlayer.reset();
////            mediaPlayer.setDataSource(url);
////            mediaPlayer.prepareAsync();
////            mediaPlayer.setSurface(new Surface(textureEntry.surfaceTexture())); // 非常重要，reset之后需重新设置Surface，播放器才能渲染
//
//        }
//
//        long getPosition() {
...
//                }
//                TextureRegistry.SurfaceTextureEntry handle = textures.createSurfaceTexture();
//                onMethodCall(call, result, textureId, player,handle);
//                break;
//            }
//        }
//    }
//
//    private void onMethodCall(MethodCall call, Result result, long textureId, VideoPlayer player,      TextureRegistry.SurfaceTextureEntry textureEntry) {
//        switch (call.method) {
//            case "setLooping":
...
//                break;
//            case"reload":
//                player.reload((String) call.argument("dataSource"));
//                break;
//            case "pause":
//                player.pause();
//                result.success(null);
...
//    }
  ...
  private   LinearLayout.LayoutParams layoutParams;
    public VideoPlayerPlugin(Registrar registrar) {
        ...
        this.registrar = registrar;
        ksyPlayerView  = new KsyPlayerView(registrar.context(),registrar,layoutParams);
    }
    ...
    public void onMethodCall(MethodCall methodCall, Result result) {
        if (methodCall.method.equals("init")) {
            registrar.activity().addContentView(ksyPlayerView,layoutParams);
